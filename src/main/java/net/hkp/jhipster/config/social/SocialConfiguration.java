package net.hkp.jhipster.config.social;

import net.hkp.jhipster.repository.SocialUserConnectionRepository;
import net.hkp.jhipster.repository.CustomSocialUsersConnectionRepository;
import net.hkp.jhipster.security.jwt.TokenProvider;
import net.hkp.jhipster.security.social.CustomSignInAdapter;
