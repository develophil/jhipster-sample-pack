...
import net.hkp.jhipster.config.audit.AuditEventConverter;
import net.hkp.jhipster.domain.PersistentAuditEvent;
import net.hkp.jhipster.repository.PersistenceAuditEventRepository;
import net.hkp.jhipster.service.AuditEventService;
